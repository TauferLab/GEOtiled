...
geotiled_esience.download_files(data_10m_file, 'dem_tiles')
geotiled_esience.build_mosaic('dem_tiles','mosaic.tif', cleanup=True)
...
geotiled_esience.fetch_dem(bbox={"xmin": -98.00, "ymin": 47.00, "xmax": -96.00, "ymax": 45.00}, dataset="10m", save_to_txt=False, download=True)
geotiled_esience.build_mosaic('dem_tiles','pre_flat.tif', cleanup=True)
crop('pre_flat.tif', 'flat.tif', [0, 0, 20000, 20000], cleanup=True)

# Download and preprocess mountain dataset
geotiled_esience.fetch_dem(bbox={"xmin": -112.00, "ymin": 44.00, "xmax": -110.00, "ymax": 42.00}, dataset="10m", save_to_txt=False, download=True)
geotiled_esience.build_mosaic('dem_tiles','pre_mountain.tif', cleanup=True)
